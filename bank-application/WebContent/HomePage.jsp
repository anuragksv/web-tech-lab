...
<li id="notactive"><a href="HomePage.jsp">Transfer Funds</a></li> 
<li id="notactive"><a href="HomePage.jsp">Withdraw</a></li> 
<li id="notactive"><a href="HomePage.jsp">Deposit</a></li> 
<li id="notactive"><a href="HomePage.jsp">Transaction History</a></li> 
</ul>
</div>
...
<div>
    <a href="HomePage.jsp" target="_blank">About</a>
</div>
<div id="hover_nav">
    <a href="">Our Services <i class="fa fa-caret-down"></i></a>
    <ul class="hover_nav_content">
        <li><a href="HomePage.jsp">Loan Application</a></li>
        <li><a href="HomePage.jsp">Credit</a></li>
        <li><a href="HomePage.jsp">Check Book</a></li>
    </ul>
</div>
<div>
    <a href="HomePage.jsp" target="_blank">Contact Us</a>
</div>
<div>
